export const CONV_TOPICS = [
  ...
  },
  {
    ...
    sentences: [
      ...
      { zh: "现在几点了？", pinyin: "Xiànzài jǐ diǎn le?", meaning: "What time is it now?", words: [{w:"现在",p:"xiànzài",m:"now"},{w:"几",p:"jǐ",m:"how many"},{w:"点",p:"diǎn",m:"o'clock"},{w:"了",p:"le",m:"particle (change of state)"}] },
  ...
  },
  {
    ...
    sentences: [
      ...
      { zh: "周末是星期六和星期日。", pinyin: "Zhōumò shì xīngqīliù hé xīngqīrì.", meaning: "The weekend is Saturday and Sunday.", words: [{w:"周末",p:"zhōumò",m:"weekend"},{w:"是",p:"shì",m:"is"},{w:"星期六",p:"xīngqīliù",m:"Saturday"},{w:"和",p:"hé",m:"and"},{w:"星期日",p:"xīngqīrì",m:"Sunday"}] },
